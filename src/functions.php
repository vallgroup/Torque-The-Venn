 ...
 * Head additions
 */ 
add_action('wp_head', 'output_head_additions');
function output_head_additions(){ ?>

  <!-- Global site tag (gtag.js) - Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-152242118-1"></script>
  <script>
  ...
  <script>
    ...
    fbq('init', '204683960590974');
    fbq('track', 'PageView');
  </script>
  <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=204683960590974&ev=PageView&noscript=1"
  /></noscript>
